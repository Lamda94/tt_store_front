    ...
    <div className={`col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${product.category}`}>
            <div className="block2">
                <div className="block2-pic hov-img0" onClick={showModal}>
                    <Image src={product.image} alt={product.name} width={270} height={334} className='img-fluid'/>
                ...
                <div className="block2-txt flex-w flex-t p-t-14">
                    <div className="block2-txt-child1 flex-col-l">
                        <Link href="#" className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">{product.name}</Link>
